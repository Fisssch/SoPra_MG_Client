		...
		<div className={styles.page}>
			<main className={styles.main}>
				...
				<ol>
					...
					<li>
						<code>app/users/[id]/page.tsx</code> is a slug page that shows info of a particular user. Since each user has its own id, each
						user has its own infopage, dynamically with the use of slugs.
					</li>
					<li>
				...
				<div className={styles.ctas}>
					...
					<Button
						type='default'
						variant='solid'
						onClick={() => globalThis.open('https://nextjs.org/docs', '_blank', 'noopener,noreferrer')}
						target='_blank'
						rel='noopener noreferrer'>
						Read our docs
					</Button>
